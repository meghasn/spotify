...
from data_functions import offset_api_limit, get_artists_df, get_tracks_df, get_track_audio_df,get_all_playlist_tracks_df, get_recommendations
...
print(playlist_tracks_df[playlist_tracks_df['playlist_name'].isin(["Chill", "Chill '20", "Chill '19", "Chill '18", "Your Top Songs 2020", "Your Top Songs 2019", "Your Top Songs 2018"])].drop_duplicates(subset='id', keep="first")['id'].tolist())
...
print(playlist_dict)
print(recommendation_tracks)
recommendation_tracks_df = get_tracks_df(recommendation_tracks)
print(recommendation_tracks.columns.tolist())
